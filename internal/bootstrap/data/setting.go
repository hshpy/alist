...
func InitialSettings() []model.SettingItem {
	...
	"epub": {
		...
		{Key: conf.AutoRenderReadme, Value: "true", Type: conf.TypeBool, Group: model.GLOBAL},
		{Key: conf.FilterMarkdownScripts, Value: "true", Type: conf.TypeBool, Group: model.GLOBAL},
